...
class AddAssetForm extends Component {
  ...
  selectAssetHandler(event) { 
    this.setState({selectedAsset: event.target.value})
  }
  ...
  renderSelectedForm(param) {
    switch(param) {
      ...
      case 'mobile_form':
        return <form name="mobile_form" id="mobile_form">
              Mobile form
              </form>;
      default:
        return null;
      ...
      <div>
        ...
        <div className="add_asset_container">
          ...
          <form id='id_choose_asset'>
            <select value={this.state.selectedAsset} onChange={this.selectAssetHandler}>
